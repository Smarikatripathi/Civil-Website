...
const PowerConverter: React.FC = () => {
  ...
  const unitCategories = {
    power: {
      icon: <FiBatteryCharging className="text-purple-500" />,
      units: [
        { id: "watt", name: "Watts", symbol: "W" },
        { id: "kilowatt", name: "Kilowatts", symbol: "kW" },
        { id: "horsepower", name: "Horsepower", symbol: "hp" },
        { id: "btu-hr", name: "BTU/hour", symbol: "BTU/h" },
        { id: "ton-refrig", name: "Tons of Refrigeration", symbol: "TR" },
  ...
  const getUnitSymbol = (unit: string) => {
    return unitCategories.power.units.find((u) => u.id === unit)?.symbol || "";
  };

  const popularConversions = [
    { from: "watt", to: "kilowatt" },
    { from: "horsepower", to: "watt" },
    { from: "btu-hr", to: "ton-refrig" },
    { from: "kilowatt", to: "horsepower" },
    { from: "ton-refrig", to: "btu-hr" },
    { from: "erg-second", to: "watt" },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600 mb-8">
            Power Converter
          </h1>
          ...
          <div className="grid gap-8 mb-8">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-6 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold rounded-2xl shadow-xl hover:shadow-2xl transition-all text-xl"
            >
              CONVERT NOW
            </motion.button>
