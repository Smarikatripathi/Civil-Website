...
const ForceConverter: React.FC = () => {
  ...
  const [toUnit, setToUnit] = useState("kilonewton");
  const [isFromOpen, setIsFromOpen] = useState(false);
  const [isToOpen, setIsToOpen] = useState(false);

  const unitCategories = {
    force: {
      icon: <FiAnchor className="text-blue-500" />,
      units: [
        { id: "newton", name: "Newtons", symbol: "N" },
        { id: "kilonewton", name: "Kilonewtons", symbol: "kN" },
        { id: "pound-force", name: "Pound-force", symbol: "lbf" },
        { id: "dyne", name: "Dyne", symbol: "dyn" },
        { id: "kilogram-force", name: "Kilogram-force", symbol: "kgf" },
        { id: "poundal", name: "Poundal", symbol: "pdl" },
      ],
    },
  };
  ...
  const getUnitSymbol = (unit: string) => {
    return unitCategories.force.units.find((u) => u.id === unit)?.symbol || "";
  };

  const popularConversions = [
    { from: "newton", to: "kilonewton" },
    { from: "pound-force", to: "newton" },
    { from: "kilogram-force", to: "newton" },
    { from: "dyne", to: "newton" },
    { from: "poundal", to: "newton" },
    { from: "kilonewton", to: "pound-force" },
  ];
                ...
                <div className="relative flex-1">
                  ...
                  >
                    <span className="flex items-center gap-2">
                      <FiAnchor className="text-blue-500" />
