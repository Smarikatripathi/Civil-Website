...
import { FiArrowLeft, FiChevronDown, FiRepeat, FiWind } from "react-icons/fi";
...
const SpeedConverter: React.FC = () => {
  ...
  const unitCategories = {
    speed: {
      ...
      units: [
        { id: "mps", name: "Meters/Second", symbol: "m/s" },
        { id: "kph", name: "Kilometers/Hour", symbol: "km/h" },
        { id: "mph", name: "Miles/Hour", symbol: "mph" },
        { id: "knot", name: "Knots", symbol: "kn" },
        { id: "fps", name: "Feet/Second", symbol: "ft/s" },
  ...
  const conversionFactors: { [key: string]: number } = {
    ...
    mach: 343, // 1 Mach ≈ 343 m/s (at sea level)
  };
  ...
  const getUnitSymbol = (unit: string) => {
    return unitCategories.speed.units.find((u) => u.id === unit)?.symbol || "";
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <div className="grid gap-8 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
              <div className="relative">
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-1 rounded-2xl">
                  <input
                    type="number"
                    value={inputValue}
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-6 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-2xl shadow-xl hover:shadow-2xl transition-all text-xl"
            >
              CONVERT NOW
            </motion.button>
          ...
          <div className="mt-6 p-6 rounded-xl bg-gradient-to-r from-blue-100/50 to-indigo-100/50 border-2 border-dashed border-blue-200 text-center">
