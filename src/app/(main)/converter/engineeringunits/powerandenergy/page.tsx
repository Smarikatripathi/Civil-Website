...
const WorkPowerEnergyConverter: React.FC = () => {
  const [inputValue, setInputValue] = useState<string>("");
  const [convertedValue, setConvertedValue] = useState<string>("");
  const [fromUnit, setFromUnit] = useState("joule");
  const [toUnit, setToUnit] = useState("watt-hour");
  ...
  const unitCategories = {
    energy: {
      icon: <FiBattery className="text-purple-500" />,
      units: [
        ...
        { id: "foot-pound", name: "Foot-pound", symbol: "ft·lb" },
      ],
    },
    power: {
      ...
      units: [
        ...
        { id: "btu-hr", name: "BTU/hour", symbol: "BTU/h" },
        { id: "ton-refrig", name: "Ton of Refrigeration", symbol: "TR" },
        { id: "erg-second", name: "Erg per second", symbol: "erg/s" },
      ],
    },
    work: {
      icon: <FiActivity className="text-blue-500" />,
      units: [
        { id: "newton-meter", name: "Newton-meter", symbol: "N·m" },
        { id: "joule", name: "Joule", symbol: "J" },
        { id: "kilojoule", name: "Kilojoule", symbol: "kJ" },
        { id: "megajoule", name: "Megajoule", symbol: "MJ" },
  ...
  const popularConversions = [
    { from: "joule", to: "kilowatt-hour" },
    { from: "watt", to: "horsepower" },
    { from: "newton-meter", to: "joule" },
    { from: "btu", to: "kilojoule" },
    { from: "calorie", to: "joule" },
    { from: "ton-refrig", to: "kilowatt" },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-orange-600 mb-8">
            Work, Power & Energy Converter
          </h1>
          ...
          <div className="grid gap-8 mb-8">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-6 bg-gradient-to-r from-purple-600 to-orange-600 text-white font-bold rounded-2xl shadow-xl hover:shadow-2xl transition-all text-xl"
            >
              CONVERT NOW
            </motion.button>
...
export default WorkPowerEnergyConverter;
