  ...
  const unitCategories = {
    common: {
      ...
      units: [
        ...
        { id: "kilometers", name: "Kilometers", symbol: "km" },
    ...
    nepali: {
      ...
      units: [
        { id: "haat", name: "Haat", symbol: "haat" },
        { id: "gaj", name: "Gaj", symbol: "gaj" },
        { id: "kosh", name: "Kosh", symbol: "kosh" },
        { id: "ropani", name: "Ropani", symbol: "ropani" },
        { id: "bigha", name: "Bigha", symbol: "bigha" },
      ],
    },
    scientific: {
      ...
      units: [
        ...
        { id: "microns", name: "Microns", symbol: "µm" },
        { id: "mils", name: "Mils", symbol: "mil" },
        { id: "nautical-miles", name: "Nautical Miles", symbol: "nmi" },
