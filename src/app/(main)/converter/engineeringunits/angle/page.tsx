...
const AngleConverter: React.FC = () => {
  ...
  const unitCategories = {
    common: {
      ...
      units: [
        { id: "degrees", name: "Degrees", symbol: "°" },
        { id: "radians", name: "Radians", symbol: "rad" },
        { id: "gradians", name: "Gradians", symbol: "gon" },
      ],
    },
    scientific: {
      icon: <FiSliders className="text-purple-500" />,
      units: [
        { id: "minutes", name: "Minutes", symbol: "'" },
        { id: "seconds", name: "Seconds", symbol: '"' },
        { id: "revolutions", name: "Revolutions", symbol: "rev" },
      ],
    },
  };
  ...
  const popularConversions = [
    ...
    { from: "radians", to: "gradians" },
    { from: "degrees", to: "minutes" },
    { from: "minutes", to: "seconds" },
    { from: "revolutions", to: "degrees" },
