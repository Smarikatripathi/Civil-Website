...
const PressureConverter: React.FC = () => {
  ...
  const unitCategories = {
    common: {
      icon: <GiClockwork className="text-blue-500" />,
      units: [
    ...
    scientific: {
      ...
      units: [
        ...
        { id: "inh2o", name: "inH₂O", symbol: "inH₂O" },
        { id: "mbar", name: "Millibar", symbol: "mbar" },
        { id: "kgcm2", name: "kg/cm²", symbol: "kg/cm²" },
      ],
    },
    engineering: {
      ...
      units: [
        ...
        { id: "ksi", name: "KSI", symbol: "ksi" },
        { id: "psf", name: "PSF", symbol: "psf" },
        { id: "barye", name: "Barye", symbol: "Ba" },
      ],
    },
  };
